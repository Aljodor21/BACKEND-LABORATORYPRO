...
--TABLA AVANCES
ALTER TABLE avances ADD CONSTRAINT PK_ID_AVANCE PRIMARY KEY(id_avance);
...
--CONSTRAINTS TABLA AVANCES CON LA POSIBILIDAD DE RETROALIMENTACIÓN DEL PROFESOR
ALTER TABLE avances ADD CONSTRAINT FK_CODIGO_PROYECTO_CODIGO_USUARIO_PROYECTOS_USUARIOS FOREIGN KEY(codigo_proyecto,codigo_usuario) REFERENCES proyectos_usuarios(codigo_proyecto,codigo_usuario);

ALTER TABLE avances ADD CONSTRAINT FK_CODIGO_PROFESOR_USUARIOS FOREIGN KEY(codigo_coordinador) REFERENCES usuarios(id_usuario);

ALTER TABLE avances ADD CONSTRAINT NN_CODIGO_PROYECTO CHECK(codigo_proyecto IS NOT NULL);
ALTER TABLE avances ADD CONSTRAINT NN_CODIGO_USUARIO CHECK(codigo_usuario IS NOT NULL);